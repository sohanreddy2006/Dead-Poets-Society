    ...
    <>
      ...
      {tournament === "Cricket Sultans" && (
        <div className="r16-banner" style={{
          ...
          <div style={{ fontSize: 18, lineHeight: 1 }}>🏏</div>
          <div>
            <div style={{ fontWeight: 700, fontSize: 13.5 }}>Cricket Sultans — Reached Round of 16</div>
            <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 2 }}>Finished with 5 wins and 5 losses in the group stage.</div>
          </div>
        </div>
      )}
